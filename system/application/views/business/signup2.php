...
<div id="step2" class="step2 row">
    ...
    <fieldset>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" name="bus_contact_first" id="bus_contact_first" size="30" maxlength="50" value="<?php echo set_value('bus_contact_first'); ?>">
            </div>
        </div>
        <div class="control-group">
            <label class="control-label" for="bus_contact_last">Contact Last Name:</label>
            <div class="controls">
                <input type="text" name="bus_contact_last" id="bus_contact_last" size="30" maxlength="50" value="<?php echo set_value('bus_contact_last'); ?>">
            </div>
        </div>
        <div class="control-group">
            <label class="control-label" for="bus_name">Business Name:</label>
            <div class="controls">
                <input type="text" name="bus_name" id="bus_name" size="30" maxlength="50" value="<?php echo set_value('bus_name'); ?>">
            </div>
        </div>
        <div class="control-group">
            <label class="control-label" for="bus_address1">Address 1:</label>
            <div class="controls">
                <input type="text" name="bus_address1" id="bus_address1" size="30" maxlength="50" value="<?php echo set_value('bus_address1'); ?>">
            </div>
        </div>
        <div class="control-group">
            <label class="control-label" for="bus_address2">Address 2:</label>
            <div class="controls">
            <input type="text" name="bus_address2" id="bus_address2" size="30" maxlength="50" value="<?php echo set_value('bus_address2'); ?>">
            </div>
        </div>
        <div class="control-group">
            <label class="control-label" for="bus_city">City:</label>
            <div class="controls">
                <input type="text" name="bus_city" id="bus_city" maxlength="50" value="<?php echo set_value('bus_city'); ?>">
            </div>
        </div>
        <div class="control-group">
            <label class="control-label" for="bus_state">State:</label>
            <div class="controls">
                <select name="bus_state" id="bus_state" size="1"> <option selected="selected" value="<?php echo set_value('bus_state'); ?>">Select State--&gt;</option> 
                          ...
                          <option value="VA">Virginia</option> <option value="DC">Washington D.C.</option> <option value="WA">Washington</option> 
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" name="bus_zip" id="bus_zip" maxlength="10" value="<?php echo set_value('bus_zip'); ?>">
            </div>
        </div>
